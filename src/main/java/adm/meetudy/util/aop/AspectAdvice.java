...
//    @Pointcut("execution(* adm.meetudy.controller..*.*(..)) && !within(adm.meetudy.controller.chat.ChatController)")
    @Pointcut("execution(* adm.meetudy.controller..*.*(..))")
    private void cut() {}
