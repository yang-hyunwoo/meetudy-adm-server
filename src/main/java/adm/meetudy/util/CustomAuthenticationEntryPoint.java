package adm.meetudy.util;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import adm.meetudy.constant.login.LoginErrorCode;
import adm.meetudy.property.AdmJwtProperty;
import adm.meetudy.util.response.Response;
import adm.meetudy.util.response.ResponseBuilder;
...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public CustomAuthenticationEntryPoint(AdmJwtProperty jwtProperty) {
