package adm.meetudy.repository.study;

import adm.meetudy.constant.study.JoinStatusEnum;
import adm.meetudy.domain.member.Member;
import adm.meetudy.dto.request.study.group.StudyGroupPageReqDto;
import adm.meetudy.dto.response.main.MainStudyGroupResDto;
import adm.meetudy.dto.response.study.group.StudyGroupDetailResDto;
import adm.meetudy.dto.response.study.group.StudyGroupPageResDto;
import adm.meetudy.dto.response.study.group.StudyGroupStatusResDto;
import adm.meetudy.dto.response.study.join.GroupScheduleDayResDto;
import adm.meetudy.dto.response.study.join.GroupScheduleMonthResDto;
import adm.meetudy.dto.response.study.operate.GroupOperateResDto;
import adm.meetudy.dto.response.study.operate.StudyGroupUpdateDetailResDto;
