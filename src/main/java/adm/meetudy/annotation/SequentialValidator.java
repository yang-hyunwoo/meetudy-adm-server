...
import adm.meetudy.exception.CustomApiFieldException;
import adm.meetudy.exception.CustomApiFieldListException;
import adm.meetudy.util.response.ValidationErrorResponse;
    ...
    public <T> void validate(T dto, Class<?>[] groupOrder) {
        for (Class<?> group : groupOrder) {
            ...
            if (!violations.isEmpty()) {
                ...
                throw new CustomApiFieldException(BAD_REQUEST,v.getMessage(), errorEnum,field);
            }
        }
    }
